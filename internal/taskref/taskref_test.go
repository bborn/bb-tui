...
func TestResolve(t *testing.T) {
	store := fakeStore{tasks: []*db.Task{
		{ID: 5187, PRURL: "https://github.com/acmestore/acmestore/pull/3482"},
		{ID: 7, PRURL: "https://github.com/other/repo/pull/3482"},
		{ID: 5401, PRURL: "https://github.com/acmestore/acmestore/pull/3652"},
		{ID: 5402, PRURL: "https://github.com/acmestore/acmestore/pull/36520"},
		{ID: 8, PRURL: "https://github.com/acmestore/acmestore/pull/100"},
		{ID: 9, PRURL: "https://github.com/acmestore/acmestore/pull/100"},
	}}
	...
	for _, tt := range []struct {
		...
		{"https://github.com/acmestore/acmestore/pull/3482", 5187},
		{"https://github.com/AcmeStore/acmestore/pull/3482/files?w=1", 5187},
		{"github.com/acmestore/acmestore/pull/3652", 5401},
		{"https://github.com/acmestore/acmestore/pull/100", 0}, // two tasks share it
		{"https://github.com/acmestore/acmestore/pull/4", 0},
		{"99999", 0},
		{"draft offers", 0},
		{"fix 5187-thing", 0},
	} {
