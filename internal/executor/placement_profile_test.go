...
// onto /Users/you/.claude-ik and then placed on a Linux host, where that path
...
func TestRemotePlacementDropsALocalClaudeProfile(t *testing.T) {
	...
	if err := database.UpdateTaskClaudeConfigDir(task.ID, "/Users/you/.claude-ik"); err != nil {
		t.Fatal(err)
	}
	task.ClaudeConfigDir = "/Users/you/.claude-ik"
...
func TestLocalPlacementKeepsItsClaudeProfile(t *testing.T) {
	...
	const profile = "/Users/you/.claude-ik"
