...
func TestMatchesQueryPRSearch(t *testing.T) {
	taskWithPR := &db.Task{
		...
		PRURL:    "https://github.com/acmestore/acmestore/pull/2382",
		PRNumber: 2382,
	}
	...
	tests := []struct {
		...
		{"match by PR URL full", taskWithPR, "https://github.com/acmestore/acmestore/pull/2382", true},
		{"match by PR URL partial", taskWithPR, "acmestore/pull/2382", true},
		{"match by PR URL path", taskWithPR, "pull/2382", true},
		{"match by PR URL repo", taskWithPR, "acmestore", true},
...
func TestExtractPRNumber(t *testing.T) {
	tests := []struct {
		...
		{"full github URL", "https://github.com/acmestore/acmestore/pull/2382", 2382},
...
func TestScoreTaskBranchAndPR(t *testing.T) {
	taskWithBranch := &db.Task{
		...
		BranchName: "task/1068-i-should-be-able-to-paste-in-a-git-branc",
		PRNumber:   2382,
		PRURL:      "https://github.com/bborn/bb-tui/pull/2382",
	}
	...
	tests := []struct {
		...
		{"pasted github PR URL", taskWithBranch, "https://github.com/bborn/bb-tui/pull/2382", 900},
...
func TestFilterTasksFindsByGitHubPRURL(t *testing.T) {
	tasks := []*db.Task{
		...
		{ID: 42, Title: "Fix auth bug", Status: db.StatusProcessing,
			PRNumber: 2382, PRURL: "https://github.com/acmestore/acmestore/pull/2382"},
		{ID: 3, Title: "Another task", Status: db.StatusQueued},
	}
	...
	m.searchInput.SetValue("https://github.com/acmestore/acmestore/pull/2382")
	m.filterTasks()
