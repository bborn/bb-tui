...
var csiKeyMap = map[string]tea.Msg{
	// Shift+Enter: insert a newline rather than submit. It arrives as alt+enter
	// so a composer that submits on enter can still tell the two apart; the
	// textarea is handed a plain enter, which it binds to InsertNewline.
	"13;2u":     tea.KeyMsg{Type: tea.KeyEnter, Alt: true},
	"27;2;13~":  tea.KeyMsg{Type: tea.KeyEnter, Alt: true},
	"13;6u":     tea.KeyMsg{Type: tea.KeyEnter, Alt: true}, // shift+ctrl+enter
	"27;6;13~":  tea.KeyMsg{Type: tea.KeyEnter, Alt: true},
	"13;10u":    tea.KeyMsg{Type: tea.KeyEnter, Alt: true}, // shift+super+enter
	"27;10;13~": tea.KeyMsg{Type: tea.KeyEnter, Alt: true},
